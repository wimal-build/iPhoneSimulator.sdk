 ...
 * created from /SourceCache/xnu_headers_Sim/xnu-1735.46/bsd/kern/syscalls.master
 */
...
void munge_wlwwwll(const void *, void *);  
void munge_wlwwwllw(const void *, void *);  
void munge_wlwwlwlw(const void *, void *);  
void munge_wllwwll(const void *, void *);  
...
void munge_wwwwwlww(const void *, void *);  
void munge_wwwwwllw(const void *, void *);  
void munge_wwwwwlll(const void *, void *);  
...
#else 
/* ARM does not need mungers for BSD system calls */
#define munge_w  NULL 
...
#define munge_wlwwwll  NULL 
#define munge_wlwwwllw  NULL 
#define munge_wlwwlwlw  NULL 
#define munge_wllwwll  NULL 
...
#define munge_wwwwwlww  NULL 
#define munge_wwwwwllw  NULL 
#define munge_wwwwwlll  NULL 
...
/* Active 64-bit user ABIs do not need munging */
#define munge_d  NULL 
...
#else
#endif
struct shared_region_slide_np_args {
	char slide_l_[PADL_(uint32_t)]; uint32_t slide; char slide_r_[PADR_(uint32_t)];
	char entry_start_address_l_[PADL_(user_addr_t)]; user_addr_t entry_start_address; char entry_start_address_r_[PADR_(user_addr_t)];
	char entry_size_l_[PADL_(uint32_t)]; uint32_t entry_size; char entry_size_r_[PADR_(uint32_t)];
...
#else
#endif
int shared_region_slide_np(struct proc *, struct shared_region_slide_np_args *, int *);
