...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64Add(SInt64 left, SInt64 right) { return (SInt64)(left) + (SInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64Subtract(SInt64 left, SInt64 right) { return (SInt64)(left) - (SInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64Multiply(SInt64 left, SInt64 right) { return (SInt64)(left) * (SInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64Mod(SInt64 dividend, SInt64 divisor) { return (SInt64)(dividend) % (SInt64)(divisor); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64Divide(SInt64 dividend, SInt64 divisor, SInt64 *remainder) { return ( (void)((remainder) && (*((SInt64*)(remainder)) = ((SInt64)(dividend) % (SInt64)(divisor)))), ((SInt64)(dividend) / (SInt64)(divisor)) ); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64Div(SInt64 dividend, SInt64 divisor) { return S64Divide((dividend), (divisor), NULL); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline Boolean S64And(SInt64 left, SInt64 right) { return (SInt64)(left) && (SInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline Boolean S64Or(SInt64 left, SInt64 right) { return (SInt64)(left) || (SInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline Boolean S64Eor(SInt64 left, SInt64 right) { return (Boolean)(((SInt64)(left) ? 1 : 0) ^ ((SInt64)(right) ? 1 : 0)); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64BitwiseAnd(SInt64 left, SInt64 right) { return (SInt64)(left) & (SInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64BitwiseOr(SInt64 left, SInt64 right) { return (SInt64)(left) | (SInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64BitwiseEor(SInt64 left, SInt64 right) { return (SInt64)(left) ^ (SInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64ShiftRight(SInt64 value, UInt32 shift) { return (SInt64)(value) >> ((shift) & 0x7F); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline SInt64 S64ShiftLeft(SInt64 value, UInt32 shift) { return (SInt64)(value) << ((shift) & 0x7F); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline long double SInt64ToLongDouble(SInt64 value) { return (long double)(value); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64Add(UInt64 left, UInt64 right) { return (UInt64)(left) + (UInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64Subtract(UInt64 left, UInt64 right) { return (UInt64)(left) - (UInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64Multiply(UInt64 left, UInt64 right) { return (UInt64)(left) * (UInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64Mod(UInt64 dividend, UInt64 divisor) { return (UInt64)(dividend) % (UInt64)(divisor); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64Divide(UInt64 dividend, UInt64 divisor, UInt64 *remainder) { return ( (void)((remainder) && (*((UInt64*)(remainder)) = ((UInt64)(dividend) % (UInt64)(divisor)))), ((UInt64)(dividend) / (UInt64)(divisor)) ); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64Div(UInt64 dividend, UInt64 divisor) { return U64Divide((dividend), (divisor), NULL); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline Boolean U64And(UInt64 left, UInt64 right) { return (UInt64)(left) && (UInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline Boolean U64Or(UInt64 left, UInt64 right) { return (UInt64)(left) || (UInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline Boolean U64Eor(UInt64 left, UInt64 right) { return (Boolean)(((UInt64)(left) ? 1 : 0) ^ ((UInt64)(right) ? 1 : 0)); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64BitwiseAnd(UInt64 left, UInt64 right) { return (UInt64)(left) & (UInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64BitwiseOr(UInt64 left, UInt64 right) { return (UInt64)(left) | (UInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64BitwiseEor(UInt64 left, UInt64 right) { return (UInt64)(left) ^ (UInt64)(right); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64ShiftRight(UInt64 value, UInt32 shift) { return (UInt64)(value) >> ((shift) & 0x7F); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline UInt64 U64ShiftLeft(UInt64 value, UInt32 shift) { return (UInt64)(value) << ((shift) & 0x7F); }
  #else
...
#if TYPE_LONGLONG
  #if MATH64_USE_INLINE
    inline long double UInt64ToLongDouble(UInt64 value) { return (long double)(value); }
  #else
