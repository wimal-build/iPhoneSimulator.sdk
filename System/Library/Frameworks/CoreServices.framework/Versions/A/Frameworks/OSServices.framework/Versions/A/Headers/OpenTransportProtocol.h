...
struct qband {
  ...
  unsigned short      qb_flag;                /* еее╩state */
  short               qb_pad1;                /* еее reserved */
};
...
struct queue {
  ...
  unsigned short      q_flag;                 /* еее queue state */
  unsigned char       q_nband;                /* еее number of bands */
  unsigned char       q_pad1[1];              /* еее reserved */
...
/*  -------------------------------------------------------------------------
    ...
    enum                                                                /* this line deleted for release disk */
    {                                                                   /* this line deleted for release disk */
        kOTBenignChange = 0, kOTKillsServices = 1, kOTMustReboot = 2,   /* this line deleted for release disk */
        kOTIncompatiblePrefs = 3                                        /* this line deleted for release disk */
    };                                                                  /* this line deleted for release disk */
                                                                        /* this line deleted for release disk */
    enum                                                                /* this line deleted for release disk */
    {                                                                   /* this line deleted for release disk */
        kOTConfiguratorIsMasterBit = 0                                  /* this line deleted for release disk */
    };                                                                  /* this line deleted for release disk */
                                                                        /* this line deleted for release disk */
...
#endif
    {
        ...
        public:
            ...
            virtual Boolean     _MDECL CheckUseCounts()                                     = 0;            /* this line deleted for release disk */
            virtual SInt32*     _MDECL GetUseCountPtr(OTPortRef theRef)                     = 0;            /* this line deleted for release disk */
                                                                                                            /* this line deleted for release disk */
                                                                                                            /* this line deleted for release disk */
            virtual OTResult    _MDECL RemoveInterface(OTPortRef, OTResult why, OTBooleanParam doneDeal) = 0;   /* this line deleted for release disk */
                                                                                                            /* this line deleted for release disk */
            virtual OTResult    _MDECL AddInterface(OTConfigurationRef, void* prefs, OTCommand cmd) = 0;        /* this line deleted for release disk */
                                                                                                            /* this line deleted for release disk */
            virtual OTResult    _MDECL CheckPreferenceChanges(void* contextPtr, OTPortRef,                  /* this line deleted for release disk */
                                                              UInt32 which, void* prefs)    = 0;            /* this line deleted for release disk */
            virtual OTResult    _MDECL ChangePreferences(void* contextPtr, OTPortRef,                       /* this line deleted for release disk */
                                                         UInt32 which, void* prefs)         = 0;            /* this line deleted for release disk */
    };
