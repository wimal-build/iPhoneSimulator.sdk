...
#if !defined(__OPENDIRECTORY_CFOPENDIRECTORYCONSTANTS__)
#define __OPENDIRECTORY_CFOPENDIRECTORYCONSTANTS__ 1
...
#endif /* ! __OPENDIRECTORY_CFOPENDIRECTORYCONSTANTS__ */
