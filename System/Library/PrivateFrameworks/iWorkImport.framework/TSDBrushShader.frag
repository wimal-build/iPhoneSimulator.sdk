...
void main()
{
    ...
    vec2 minMax = (vClampedTexCoords.x < vClampedTexCoords.y) ? vClampedTexCoords.xy : vClampedTexCoords.yx;
    color = (minMax.x <= vTexCoord.y && vTexCoord.y <= minMax.y) ? color : vec4(0);
