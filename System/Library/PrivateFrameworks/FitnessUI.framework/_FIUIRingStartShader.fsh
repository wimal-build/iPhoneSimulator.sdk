...
void main() {
    ...
    bool inStartCap = (startCapDistanceInPixels - 1.0 < halfRingWidth) && (coordinate.x < 0.0) && (percentages.x < 1.0);
    ...
    // Use the color multiplier to dim this 
